...
<div class="main-panel">
              ...
              <div class="row">
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    <thead>
                      <tr>
                        <th class="text-uppercase text-center text-secondary text-xxs">Picture</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="align-middle text-center"><span class="text-xs "><img src="/storage/pictures/{{ $user->picture}}" alt=""></span></td>
                        ...
                        <td class="align-middle text-center"><span class="text-xs " style="text-transform: uppercase">{{$user->matric_no}}</span></td>
                        ...
                        <td class="align-middle text-center">
                          <a href="" class=" font-weight-bold editUserBtn" data-toggle="modal" data-target="#editStudent{{$user->id}}" data-id="{{$user->id}}">
                              <i class="ti-pencil text-bold text-info"></i>
                          </a>
                          <a href="" class="text-danger font-weight-bold editUserBtn" data-toggle="modal" data-target="#deleteStudent{{$user->id}}" data-id="{{$user->id}}">
                            <i class="ti-trash text-bold text-danger"></i>
                          </a>
                          
                          <!-- Edit Student Model -->
                          <div class="modal fade" id="editStudent{{$user->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title text-primary" >Edit Student</h4>
                                ...
                                <div class="modal-body" id="editStudent">
                                  <form class="pt-3" role="form" method="POST" action="{{ url('/students/'.$user->id)}}" id="editStudent" >
                                    @csrf
                                    
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="matric_no"  style="text-transform: uppercase"
                                        placeholder="Matric No" required autocomplete="matric_no" value="{{$user->matric_no}}">
                                    </div>
                                    <div class="form-group">
                        ...
                        <!--Delete Student-->
                        <div class="modal fade" id="deleteStudent{{$user->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title text-primary" >Delete Student</h4>
                                <a class="close" type="button" data-dismiss="modal" aria-label="Close">
                                  <i class="ti-close opacity-10 text-info"></i>
                                </a>
                              </div>
                              <div class="modal-body" id="DeleteStudentModalBody">
                                <p class="lead display-4 font-weight-bold">
                                  Are you sure you wish to delete "{{$user->last_name}} {{$user->first_name}}" ?
                                </p>
                                <form method="POST" action="{{ url('/students/'. $user->id)}}" id="deleteStudent">
                                    @csrf
    ...
    <div class="modal fade" id="createLecturerModal" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title text-primary" >Create Student</h4>
            <a class="close" type="button" data-dismiss="modal" aria-label="Close">
              <i class="ti-close opacity-10 text-info"></i>
            </a>
          </div>
          <div class="modal-body" id="createStudentModalBody">
            <form class="pt-3" role="form" method="POST" action="{{ url('students')}}" id="createStudent" enctype="multipart/form-data" >
                @csrf
                
                <div class="form-group">
                    <div class="form-group">
                        <input type="text" class="form-control" name="matric_no" 
                        placeholder="Matric No" required autocomplete="matric_no" style="text-transform: uppercase">
                      </div>
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" name="last_name" 
