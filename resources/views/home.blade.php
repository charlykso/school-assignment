				 	...
				 	<!-- NAVIGATION MENU -->
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo"><a href="#hero-6" class="logo-black"><img src="images/cropped-funai_Logo-1.png" width="172" height="40" alt="header-logo"></a></div>
	    					<div class="desktoplogo"><a href="#hero-6" class="logo-white"><img src="images/logo-white.png" width="172" height="40" alt="header-logo"></a></div>
							    	...
							    	<!-- DROPDOWN MENU -->
						          	<li aria-haspopup="true">
	            						...
	            						<ul class="sub-menu last-sub-menu">
						           			...
						           			<li aria-haspopup="true"><a href="#">SignUp</a></li>
								    ...
								    <!-- DROPDOWN MENU -->
						          	<li aria-haspopup="true">
	            						...
	            						<ul class="sub-menu last-sub-menu">
						              		...
						              		<li aria-haspopup="true"><a href="#"><img src="{{ asset('images/icons/flags/china.png')}}" alt="flag-icon" /> 简体中文</a></li>
						           		</ul>
								    </li>	<!-- END DROPDOWN MENU -->
